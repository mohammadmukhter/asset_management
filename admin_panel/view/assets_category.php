...
{
    $assets_category_class->store($_POST);
}
...
{
    $id=$_GET['delid'];
    $assets_category_class->destroy($id);
}

if(isset($_GET['status_id']))
{
    $id=$_GET['status_id'];
    $assets_category_class->status_change($id);
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <tbody>
                                            ...
                                            $show_array=$assets_category_class->show();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <!-- delete button start -->
                                                    <a href="?page=assets_category&&delid=<?=$data['id']?>">
                                                        ...
                                                        <!-- update button start -->
                                                        <a href="?page=assets_category_update&&upid=<?=$data['id']?>">
                                                        ...
                                                        <!-- status button start -->
                                                        <a href="?page=assets_category&&status_id=<?=$data['id']?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
            ...
            newWin = window.open("");
            newWin.document.write("<h3 align='center'>Asset Category</h3>");
